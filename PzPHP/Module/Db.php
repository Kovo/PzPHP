...
class PzPHP_Module_Db extends PzPHP_Wrapper
{
	...
	/**
	 * @var null|PzPHP_Library_Db_Mysql_Interactions
	 */
	protected $_mysqlInteractions = null;
	...
	/**
	 * @return null|PzPHP_Library_Db_Mysql_Interactions
	 */
	public function mysqlInteract()
	{
		if($this->_mysqlInteractions === null)
		{
			$this->_mysqlInteractions = new PzPHP_Library_Db_Mysql_Interactions($this->_PzPHP);
		}

		return $this->_mysqlInteractions;
	}
	...
	public function changeUser($user, $password, $dbName = null, $serverId = -1)
	{
		switch(PzPHP_Config::get('DATABASE_MODE'))
		{
			...
			case PzPHP_Config::get('DATABASE_MYSQL'):
				return $this->mysqlInteract()->mysqlChangeUser($user, $password, $dbName, $this->getActiveServerId($serverId));
			default:
				return false;
		}
	}
